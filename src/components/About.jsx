      ...
      <div className="container m-auto h-full w-full md:w-[1000px]">
        <div id="about-content" className="flex flex-col items-center justify-between w-full gap-6 md:items-start md:flex-row">
          ...
          <div id="about-text" className="flex flex-col items-center justify-center w-full pt-6 md:items-start md:w-7/12 md:pt-0">
            ...
            <p className="py-4 leading-7 tracking-wide text-center md:text-start font-poppins">
              A front-end developer enthusiast named Muhammad Arifien Syachrizal with 6+ years of experience managing and building projects in an Indonesian State-owned Company successfully reaches
              the highest career position as a Project Manager at 27. Skilled at creating responsive websites using React, Tailwind, Bootstrap, and other frameworks or libraries. Eager to face more
